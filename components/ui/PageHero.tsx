...
export const PageHero = ({
    ...
    return (
        <section
            id="hero"
            className="relative w-full min-h-[60vh] sm:min-h-[65vh] pt-32 pb-20 sm:pt-36 sm:pb-24 lg:pt-40 lg:pb-28 flex flex-col items-center justify-center overflow-hidden bg-white"
        >
            <HeroBackground />
