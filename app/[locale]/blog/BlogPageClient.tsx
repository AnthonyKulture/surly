                    ...
                    <div className="max-w-3xl">
                        ...
                        <Reveal delay={200} duration={800}>
                            <p className="text-lg tablet:text-xl text-white/90 max-w-2xl leading-relaxed">
                                {t('hero.description')}
                                <span className="block mt-2 font-semibold text-white">{t('hero.descriptionBold')}</span>
                            </p>
                        </Reveal>
                    </div>
                </div>
                        ...
                        <>
                            ...
                            <Reveal delay={0} duration={600}>
                                <div className="flex items-center justify-between mb-10">
                                    <div>
                                        <h2 className="text-3xl font-bold text-foreground mb-2">{t('articles.title')}</h2>
                                        <p className="text-foreground-muted">
                                            {t('articles.count', { count: regularPosts.length.toString() })}
                                        </p>
                                    </div>
                                </div>
                            </Reveal>
